    ...
    >
      ...
      <el-col :span="12">
        ...
        <div v-else>
          ...
          <el-row>
            <el-col :span="24">
              <el-form-item class="textarea" v-if="type!='info'" label="事项" prop="shixiang">
                <el-input
                  style="min-width: 200px; max-width: 600px;"
                  type="textarea"
                  :rows="8"
                  placeholder="事项"
                  v-model="ruleForm.shixiang" >
                </el-input>
              </el-form-item>
              <div v-else>
                <el-form-item v-if="ruleForm.shixiang" label="事项" prop="shixiang">
                    <span>{{ruleForm.shixiang}}</span>
                </el-form-item>
              </div>
            </el-col>
          </el-row>
