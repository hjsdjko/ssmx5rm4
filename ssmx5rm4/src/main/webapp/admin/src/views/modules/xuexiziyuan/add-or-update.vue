<template>
  <div class="addEdit-block">
    ...
    >
      ...
      <el-col :span="24">  
        <el-form-item class="upload" v-if="type!='info'" label="视频学习" prop="shipinxuexi">
          <file-upload
          tip="点击上传视频学习"
          action="file/upload"
          :limit="1"
          :multiple="true"
          :fileUrls="ruleForm.shipinxuexi?ruleForm.shipinxuexi:''"
          @change="shipinxuexiUploadChange"
          ></file-upload>
        </el-form-item> 
        <div v-else>
          <el-form-item v-if="ruleForm.shipinxuexi" label="视频学习" prop="shipinxuexi">
            <el-button type="text" size="small" @click="download(ruleForm.shipinxuexi)">预览</el-button>
          </el-form-item>
        </div>
      </el-col>
      </el-row>
...
export default {
  ...
  methods: {
    ...
    shipinxuexiUploadChange(fileUrls) {
	this.ruleForm.shipinxuexi = fileUrls;
			this.addEditUploadStyleChange()
    },
	addEditStyleChange() {
	  this.$nextTick(()=>{
